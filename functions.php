...
if ( !class_exists('WPBakeryVisualComposerAbstract') ) {
	...
	$composer_settings = Array(
		...
		'USER_DIR_NAME'  => 'inc/shortcodes/vc_templates',

		//for which content types Visual Composer should be enabled by default
		'default_post_types' => Array('page', 'post', 'dt_portfolio', 'dt_benefits')
	);
...
/////////////////////////////////////////////
// Initialising Visual Composer Shortcodes //
/////////////////////////////////////////////
